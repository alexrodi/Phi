...
struct State {
    ...
    struct Listener {
        ...
        virtual void moduleAdded(ModuleID moduleID) {};
        virtual void moduleDeleted(ModuleID moduleID) {};
        virtual void moduleBoundsChanged(ModuleID moduleID, juce::Rectangle<int> bounds) {};
        
        virtual void connectionCreated(ConnectionID connectionID) {};
        virtual void connectionDeleted(ConnectionID connectionID) {};
        
        virtual void showPortLabelsChanged(ShowPortLabels show) {};
        virtual void patchCordTypeChanged(PatchCordType type) {};
    };
